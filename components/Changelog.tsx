  ...
  return (
    <section id="changelog" className="mx-auto max-w-4xl px-5 py-24">
      ...
      <div className="space-y-6">
        {releases.length === 0 ? (
          <div className="rounded-2xl border border-line/80 bg-[#0e1738]/60 p-8 text-center text-sm text-slate-400">
                ...
                {release.sections && release.sections.length > 0 && (
                  <div className="mt-5 space-y-4">
                    {release.sections.map((section) => (
                      <div key={section.id || section.title} className="rounded-xl bg-[#081028]/60 border border-line/40 p-3.5 sm:p-4">
                        <h4 className="text-[11px] font-bold tracking-wider uppercase text-azure-400 mb-2">
                          {section.title}
                        </h4>
